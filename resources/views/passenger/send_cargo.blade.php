          ...
          <div class="card">
            <div class="card-header pb-0">
              <div class="d-flex justify-content-between">
                ...
                <button class="btn btn-lg btn-info col-sm-2" data-toggle="modal" data-target="#bookCargoModal"> Send a cargo</button>
              </div>
            </div>
                  ...
                  <table class="table align-items-center mb-0">
                    <thead>
                        <tr>
                          ...
                          <th class="text-uppercase text-secondary text-xxs font-weight-bolder opacity-7 ps-2">Nature</th>
  ...
  <div class="modal-dialog" role="document">
      <div class="modal-content">
          <div class="modal-body" id="bookCargoModalBody">
            ...
            {!! Form::open(['action' => 'App\Http\Controllers\CargosController@store', 'method' => 'POST', 'id' => 'bookCargoForm']) !!}
              @csrf
