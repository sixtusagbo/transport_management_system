          ...
          <div class="card">
            <div class="card-header pb-0">
              <div class="d-flex justify-content-between">
                ...
                <button class="btn btn-lg btn-info col-sm-2" data-toggle="modal" data-target="#bookTripModal"><i class="fas fa-ticket-alt"></i> Book a trip</button>
              </div>
            </div>
                  ...
                  <table class="table align-items-center mb-0">
                    <thead>
                        <tr>
                          ...
                          <th class="text-uppercase text-secondary text-xxs font-weight-bolder opacity-7 ps-2">Depature</th>
                    ...
                    <tbody>
                        ...
                        <tr>
                          ...
                          <td>
                            <h6 class="mb-0 text-sm">{{$ticket->created_at->format('jS M\, Y')}}</h6>
                          </td>
                          <td class="text-sm">
                          ...
                          <td class="text-sm">
                            <a href="" class="text-info text-lg viewTicketBtn" data-toggle="modal" data-target="#viewTicketModal" data-id="{{$ticket->id}}">
                                <i class="fas fa-eye" style="font-size: 1.3em;" title="View Ticket"></i>
                              </a>
                          </td>
                        </tr>
                        @endforeach
  ...
  <div class="modal-dialog" role="document">
      <div class="modal-content">
          <div class="modal-body" id="bookTripModalBody">
            ...
            {!! Form::open(['action' => 'App\Http\Controllers\TripsController@store', 'method' => 'POST', 'id' => 'bookTicketForm']) !!}
              @csrf
